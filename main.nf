...
def helpMessage() {
    ...
    References                      If not specified in the configuration file or you wish to overwrite any of the references
      ...
      --save_reference               If generated by the pipeline save the BWA index in the results directory
    ...
    Alignments
      ...
      --keep_multi_map                Reads mapping to multiple locations are not filtered from alignments
