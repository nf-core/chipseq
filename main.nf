...
def helpMessage() {
    ...
    Other
      ...
      --keepMultiqcStats            Include general stats table in MultiQC report
...
summary['Keep MultiQC Stats']   = params.keepMultiqcStats ? 'Yes' : 'No'
...
process multiqc {
    ...
    mqcstats = params.keepMultiqcStats ? '' : '--cl_config "skip_generalstats: true"'
    """
